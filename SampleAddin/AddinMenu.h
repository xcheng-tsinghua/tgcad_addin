...
static const MY_COMMAND_INFO MyCommands3D[] =
{
	...
	//{ IDS_CMD_CATEGORY, IDS_CMD_GROUP_MODELTESTTOOLS , id3DSketch, IDS_CMD_3DSKETCH , IDB_MODELINGCHECK, seButtonIconAndCaptionBelow },// ≤‚ ‘7
		...
		// backbone
	{ IDS_CMD_CATEGORY, IDS_CMD_GROUP_MODELTESTTOOLS , idTest1, IDS_CMD_BN1 , IDB_PACKAGEMODELINGCHECK, seButtonIconAndCaptionBelow },// ≤‚ ‘3
	{ IDS_CMD_CATEGORY, IDS_CMD_GROUP_MODELTESTTOOLS , idTest2, IDS_CMD_BN2 , IDB_PACKAGEMODELINGCHECK, seButtonIconAndCaptionBelow },// ≤‚ ‘3
	{ IDS_CMD_CATEGORY, IDS_CMD_GROUP_MODELTESTTOOLS , idTest3, IDS_CMD_BN3 , IDB_GUIDE, seButtonIconAndCaptionBelow },// ≤‚ ‘3
	{ IDS_CMD_CATEGORY, IDS_CMD_GROUP_MODELTESTTOOLS , idTest4, IDS_CMD_BN4 , IDB_GUIDE, seButtonIconAndCaptionBelow },// ≤‚ ‘3
	{ IDS_CMD_CATEGORY, IDS_CMD_GROUP_MODELTESTTOOLS , idTest5, IDS_CMD_BN5 , IDB_GUIDE, seButtonIconAndCaptionBelow },// ≤‚ ‘4
	{ IDS_CMD_CATEGORY, IDS_CMD_GROUP_MODELTESTTOOLS , idTest6, IDS_CMD_BN6 , IDB_RECTIFY, seButtonIconAndCaptionBelow },// ≤‚ ‘3
	{ IDS_CMD_CATEGORY, IDS_CMD_GROUP_MODELTESTTOOLS , idTest7, IDS_CMD_BN7 , IDB_RECTIFY, seButtonIconAndCaptionBelow },// ≤‚ ‘4
